...
try {
    ...
    & $mkcert -install
    & $mkcert "*.multisite_poc.localhost"
...
Add-HostsEntry "cm.multisite_poc.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.multisite_poc.localhost"
}
Add-HostsEntry "id.multisite_poc.localhost"
Add-HostsEntry "www.multisite_poc.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.multisite_poc.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.multisite_poc.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.multisite_poc.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.multisite_poc.localhost"
